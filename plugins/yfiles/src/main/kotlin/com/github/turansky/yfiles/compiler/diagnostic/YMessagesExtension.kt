...
private val DIAGNOSTIC_FACTORY_TO_RENDERER by lazy {
    DiagnosticFactoryToRendererMap("yfiles").apply {
        ...
        put(
            BASE_CLASS__CONSTRUCTOR_NOT_SUPPORTED,
            "Constructor not supported for yFiles base classes"
        )
        put(
            BASE_CLASS__BODY_NOT_SUPPORTED,
            "Properties and methods not supported for yFiles base classes"
        )
        put(
